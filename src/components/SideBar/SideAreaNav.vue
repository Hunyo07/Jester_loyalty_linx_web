...
const sidebarStores = useSidebarStore();

onClickOutside(target, () => {
  sidebarStores.isSidebarOpen = false;
});

const menuGroupsy = ref([
  {
    name: "MENU",
    menuItems: [
      {
  ...
  >
    ...
    <div class="flex items-center justify-between gap-2 px-6 py-5.5 lg:py-6.5">
      <router-link to="/signin">
        <div class="flex flex-row justify-evenly item-center">
          <img
            class="w-1/4"
            src="../../assets/img/authimages/loyaltilinx-web-favicon.png"
            alt="Logo"
          />
          <h1 class="text-white text-2xl align-center my-auto font-semibold">
            Loyatly Linx
          </h1>
        </div>
      </router-link>
    ...
    >
      ...
      <nav class="mt-5 py-4 px-4 lg:mt-9 lg:px-6">
        <template v-for="menuGroup in menuGroupsy" :key="menuGroup.name">
          <div>
