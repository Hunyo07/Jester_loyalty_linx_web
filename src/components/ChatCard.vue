...
const chatData = ref([
  {
    avatar: "../assets/img/user/user-01.png",
    name: "Devid Heilo",
    text: "How are you?",
    time: 12,
    textCount: 3,
  ...
  {
    avatar: "../assets/img/user/user-02.png",
    name: "Henry Fisher",
  ...
  {
    avatar: "../assets/img/user/user-03.png",
    name: "Jhon Doe",
    text: "What's up?",
    time: 32,
    textCount: 0,
  ...
  {
    avatar: "../assets/img/user/user-04.png",
    name: "Jane Doe",
    text: "Great",
    time: 32,
    textCount: 2,
  ...
  {
    avatar: "../assets/img/user/user-05.png",
    name: "Jhon Doe",
    text: "How are you?",
    time: 32,
    textCount: 0,
